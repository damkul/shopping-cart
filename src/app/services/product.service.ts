...
export class ProductService {
  ...
  products:Product[] = [
    new Product(1,"Roadster shirt","Maroon Designer-Top",500,"..\\assets\\images\\women\\Designer-Top-For-Jeans.jpg"),
    new Product(2,"W Kurti","Ehanic Kurti",1100,"..\\assets\\images\\women\\rayon-kurti.jpg"),
    new Product(3,"Wrogen Jeans","Blue Torn Jeans",1500,"..\\assets\\images\\women\\jeans.jpg"),
    new Product(4,"Zara","Salawar Suit",500,"..\\assets\\images\\women\\salwar-suit.jpg"),
    new Product(5,"zara","Ethanic Saree",800,"..\\assets\\images\\women\\silk-saree.jpg"),
    new Product(6,"Roadster Joggers"," Olive Green Joggers",2200,"..\\assets\\images\\men\\checked-pant.jpeg"),
